...
const Footer = () => {
  return (
    <footer className="bg-background p-4 border-t-1 border-dotted border-[#ffffff33]">
        <div className="flex justify-between items-center text-gray-200 text-sm max-w-[1200px] mx-auto py-10 tracking-wide">
            <p>designed with figma &copy; 2025. Jubril Abdul</p>
            ...
            <a href="https://github.com/jubril-a/jubril-codes-v2" className="flex gap-2">
              <Image src="/icons/love.png" width={20} height={20} alt="" />
              <p>Made with passion and NextJS</p>
            </a>
        </div>
    </footer>
  )
