...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-999 w-full sm:pt-2 sm:px-4">
        <nav className="bg-[#080808d2] backdrop-blur-sm px-10 max-[480px]:px-5 py-4 flex items-center flex-wrap justify-between max-w-7xl mx-auto sm:rounded-[8px] text-[14px] text-white">
            ...
            <div className={"md:flex gap-4 items-center " + `${isVisible ? "grid order-1 w-full mt-16 gap-14 py-6 text-center" : "hidden"}`}>
                <a href="#about" className="opacity-70 hover:opacity-100" onClick={() => setVisible(false)}>AboutMe</a>
                <a href="#projects" className="opacity-70 hover:opacity-100" onClick={() => setVisible(false)}>Projects</a>
                <a href="#stack" className="opacity-70 hover:opacity-100" onClick={() => setVisible(false)}>TechStack</a>
                <a href="#experience" className="opacity-70 hover:opacity-100" onClick={() => setVisible(false)}>Experience</a>
                <a href="#message" className="opacity-70 hover:opacity-100" onClick={() => setVisible(false)}>ContactMe</a>
